...
return [
    ...
    'image'                => 'El campo :attribute debe ser una imagen válida (JPG, PNG, GIF, WEBP).',
    ...
    'max'                  => [
        ...
        'file'    => 'El archivo es demasiado grande. El máximo permitido es :max KB.',
    ...
    'password'             => [
        ...
        'uncompromised' => 'Esta :attribute ha aparecido en una filtración de datos. Por favor, elige otra.',
    ],
    ...
    'unique'               => 'Este valor ya está en uso. Por favor, elige otro.',
    'uploaded'             => 'Ha ocurrido un error al subir el archivo. Inténtalo de nuevo.',
    ...
    'custom' => [
        ...
        'password' => [
            'confirmed' => 'Las contraseñas no coinciden. Vuelve a escribirlas.',
            'min'       => 'La contraseña debe tener al menos :min caracteres.',
            'required'  => 'La contraseña es obligatoria.',
        ],
        'avatar' => [
            'image' => 'El avatar debe ser una imagen válida (JPG, PNG, GIF, WEBP).',
            'max'   => 'El avatar no puede superar los 15 MB.',
            'mimes' => 'El avatar debe ser de tipo: JPG, PNG, GIF o WEBP.',
        ],
        'imagenes' => [
            'max'   => 'No puedes adjuntar más de 4 imágenes.',
            'image' => 'Por favor, selecciona solo archivos de imagen válidos.',
        ],
        'imagenes.*' => [
            'image' => 'Uno o más archivos no son imágenes válidas.',
            'max'   => 'Cada imagen no puede superar los 15 MB.',
            'mimes' => 'Las imágenes deben ser de tipo: JPG, PNG, GIF o WEBP.',
        ],
        'titulo' => [
            'required' => 'El título de la zona es obligatorio.',
            'max'      => 'El título no puede superar los 120 caracteres.',
        ],
        'texto' => [
            'required' => 'El texto de la respuesta es obligatorio.',
            'max'      => 'La respuesta no puede superar los 1000 caracteres.',
        ],
    ],
