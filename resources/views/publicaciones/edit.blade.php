        ...
        <div class="form-row-2">
            <div class="form__group">
                ...
                <select id="temporada" name="temporada"
                    ...
                    <option value="invierno"  {{ old('temporada', $publicacion->temporada) === 'invierno'  ? 'selected' : '' }}>Invierno / Aguas Frías</option>
                    <option value="primavera" {{ old('temporada', $publicacion->temporada) === 'primavera' ? 'selected' : '' }}>Primavera / Media Estación</option>
                    <option value="verano"    {{ old('temporada', $publicacion->temporada) === 'verano'    ? 'selected' : '' }}>Verano / Alta Actividad</option>
                    <option value="otono"     {{ old('temporada', $publicacion->temporada) === 'otono'     ? 'selected' : '' }}>Otoño / Depredadores</option>
                </select>
            ...
            <div class="form__group">
                ...
                <select id="licencia" name="licencia"
                    ...
                    <option value="">Sin especificar</option>
                    <option value="interauton" {{ old('licencia', $publicacion->licencia) === 'interauton' ? 'selected' : '' }}>Licencia Interautonómica</option>
                    <option value="auton_1"    {{ old('licencia', $publicacion->licencia) === 'auton_1'    ? 'selected' : '' }}>Licencia Autonómica (1 Año)</option>
                    <option value="auton_5"    {{ old('licencia', $publicacion->licencia) === 'auton_5'    ? 'selected' : '' }}>Licencia Autonómica (5 Años)</option>
                    <option value="coto"       {{ old('licencia', $publicacion->licencia) === 'coto'       ? 'selected' : '' }}>Permiso de Coto Federado</option>
                    <option value="mar"        {{ old('licencia', $publicacion->licencia) === 'mar'        ? 'selected' : '' }}>Licencia de Mar / Costa</option>
                </select>
